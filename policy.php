    ...
    <div class="container">
        <nav class="navbar navbar-default">
            <div class="navbar-header">
                ...
                <h1><a  href="index.php">la naturalidad</a></h1>
            </div>
            <!-- top-nav -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="policy.php" class="active" >Política de privacidad</a></li>
...
<div class="footer">
    <div class="container">
        ...
        <p>Passeig Rangel, 7, Entre suelo 6º, 46945, Villa Aranda </p>
        <p>+6539054005098</p>

        <p>arriaga.daniela@pacheco.net</a></p>
        ...
        <h3><a href="index.php">la naturalidad</a></h3>
