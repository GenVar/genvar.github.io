    ...
    <div class="container">
        <nav class="navbar navbar-default">
            <div class="navbar-header">
                ...
                <h1><a  href="index.php">el amor</a></h1>
            </div>
            <!-- top-nav -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="terms.php" class="active">Términos y condiciones</a></li>
                </ul>
...
<div class="footer">
    <div class="container">
        ...
        <p>Ronda Gael, 0, Entre suelo 6º, 59968, O Soriano </p>
        <p>+8004567061113</p>

        <p>calvo.izan@yahoo.com</a></p>
        ...
        <h3><a href="index.php">el amor</a></h3>
